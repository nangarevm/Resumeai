...
export const STYLE_PROFILES: Record<string, DocxStyleProfile> = {
  ...
  "balanced-ats": { font: SANS, nameTreatment: "plain", headerTreatment: "underline", allCapsName: false, allCapsHeaders: false, letterSpaced: false },
  "centered-ats": { font: SANS, nameTreatment: "centered", headerTreatment: "underline", allCapsName: false, allCapsHeaders: false, letterSpaced: false },
  ...
  "strip-modern": { font: SANS, nameTreatment: "plain", headerTreatment: "underline", allCapsName: false, allCapsHeaders: false, letterSpaced: false },
  "column-modern": { font: SANS, nameTreatment: "plain", headerTreatment: "underline", allCapsName: false, allCapsHeaders: false, letterSpaced: false },
  ...
  "ribbon-executive": { font: SANS, nameTreatment: "plain", headerTreatment: "boxed", allCapsName: false, allCapsHeaders: false, letterSpaced: false },
  ...
  "grid-technical": { font: MONO, nameTreatment: "plain", headerTreatment: "underline", allCapsName: false, allCapsHeaders: false, letterSpaced: false },
  ...
  "dotted-creative": { font: SANS, nameTreatment: "plain", headerTreatment: "underline", allCapsName: false, allCapsHeaders: false, letterSpaced: false },
  ...
  "folio-editorial": { font: SERIF, nameTreatment: "plain", headerTreatment: "no-border", allCapsName: false, allCapsHeaders: false, letterSpaced: true },
