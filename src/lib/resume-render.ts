...
export const TEMPLATE_SKELETONS: TemplateSkeleton[] = [
  ...
  { id: "balanced-ats", name: "Balanced ATS", category: "ATS-Safe", description: "Even margins, clear hierarchy, parser-friendly.", bestFor: "Healthcare, education, and government applications", neutral: true },
  { id: "centered-ats", name: "Centered ATS", category: "ATS-Safe", description: "Centered name with understated section rules.", bestFor: "Conservative industries that still want a polished look", neutral: true },
  ...
  { id: "strip-modern", name: "Strip Modern", category: "Modern", description: "Bold accent stripe under the name block.", bestFor: "Sales, business development, and client-facing roles", neutral: false },
  { id: "column-modern", name: "Column Modern", category: "Modern", description: "Two-column header — name left, contact right.", bestFor: "Consultants and freelancers with strong personal branding", neutral: false },
  ...
  { id: "ribbon-executive", name: "Ribbon Executive", category: "Executive", description: "Accent ribbon behind each section title.", bestFor: "Senior managers and board-facing roles", neutral: false },
  ...
  { id: "grid-technical", name: "Grid Technical", category: "Technical", description: "Monospace skills in a tight grid layout.", bestFor: "Full-stack and platform engineers", neutral: false },
  ...
  { id: "dotted-creative", name: "Dotted Creative", category: "Creative", description: "Playful dotted rules between sections.", bestFor: "Marketing, content, and community roles", neutral: false },
  ...
  { id: "folio-editorial", name: "Folio Editorial", category: "Editorial", description: "Magazine-style name treatment with wide folio margins.", bestFor: "Writers, researchers, and portfolio-led careers", neutral: false },
...
export const TEMPLATE_COLORS: TemplateColor[] = [
  ...
  { id: "forest", name: "Forest", hex: "#14532d", soft: "#e8f3ec" },
  { id: "indigo", name: "Indigo", hex: "#4338ca", soft: "#ece9fe" },
  { id: "cyan", name: "Cyan", hex: "#0891b2", soft: "#e6f6fa" },
  { id: "rose", name: "Rose", hex: "#be123c", soft: "#fce8ee" }
];

export const NEUTRAL_SHADES: TemplateColor[] = [
...
/** Unique skeleton×color combinations — see buildTemplateCatalog. */
...
/** Color swatches shown in the template picker — ATS-Safe uses grayscale ink only. */
export function templateColorOptionsForCategory(category: TemplateCategory | "All"): TemplateColor[] {
  if (category === "ATS-Safe") return NEUTRAL_SHADES;
  if (category === "All") return [...NEUTRAL_SHADES, ...TEMPLATE_COLORS];
  return TEMPLATE_COLORS;
}

export function isTemplateColorValidForCategory(category: TemplateCategory | "All", colorId: string): boolean {
  if (colorId === "All") return true;
  return templateColorOptionsForCategory(category).some((c) => c.id === colorId);
}
