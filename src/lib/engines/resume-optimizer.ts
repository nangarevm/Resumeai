...
function buildOptimizedResume(
  ...
  return [
    ...
    "",
    "SUMMARY",
    candidate.parsedSections.SUMMARY || "Evidence-bound professional summary pending confirmation.",
    "",
    "SKILLS",
    skills || "Skills extracted from source resume.",
    "",
    "EVIDENCE-BOUND BULLETS (green = source-backed, yellow = confirm before send)",
